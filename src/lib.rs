...
impl KernelError {
    ...
    pub fn kind(&self) -> io::ErrorKind {
        match self.0 {
            ...
            | KERN_NO_ACCESS
            | KERN_NOT_RECEIVER
            | KERN_EXCEPTION_PROTECTED => io::ErrorKind::PermissionDenied,

            KERN_RPC_SERVER_TERMINATED | KERN_RPC_TERMINATE_ORPHAN => {
                io::ErrorKind::ConnectionAborted
            }

            KERN_NAME_EXISTS | KERN_RIGHT_EXISTS | KERN_MEMORY_PRESENT | KERN_ALREADY_WAITING => {
            ...
            | KERN_NOT_SUPPORTED
            | KERN_NOT_WAITING
            | KERN_INSUFFICIENT_BUFFER_SIZE => io::ErrorKind::InvalidInput,

            KERN_MEMORY_ERROR | KERN_NODE_DOWN | KERN_CODESIGN_ERROR | KERN_POLICY_STATIC => {
                io::ErrorKind::InvalidData
            }

            KERN_OPERATION_TIMED_OUT => io::ErrorKind::TimedOut,
